    ...
    <button
      ...
      className="group relative bg-white rounded-xl border border-gray-200 p-4 hover:shadow-lg hover:border-purple-300 transition-all duration-300 text-left min-w-[260px]">
            ...
            <div className="relative h-36 mb-2">
                ...
                {/* Center node */}
                <div className="text-white px-4 py-2 text-xs font-bold text-center rounded-[40px] absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center shadow-lg z-10 group-hover:scale-110 transition-transform"
        ...
        style={{ backgroundColor: primary }}>
          ...
          style={{ backgroundColor: secondary, opacity: 0.68 }}>
          ...
          style={{ backgroundColor: tertiary, opacity: 0.76 }}>
