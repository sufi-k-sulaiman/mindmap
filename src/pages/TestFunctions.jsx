...
import { Loader2, CheckCircle, XCircle, Send, FileText, Download, CreditCard, MessageSquare, Bot, Sparkles, Image, Upload, Mail, Grid3X3, Search, Home, Settings, User, Bell, Heart, Star, Calendar, Clock, Mail as MailIcon, Phone, Camera, Music, Video, Folder, File, Edit, Trash2, Plus, Minus, Check, X, ChevronUp, ChevronDown, ChevronLeft, ChevronRight, ArrowUp, ArrowDown, ArrowLeft, ArrowRight, Menu, MoreHorizontal, MoreVertical, Share, Link, ExternalLink, Eye, EyeOff, Lock, Unlock, Key, Shield, AlertCircle, AlertTriangle, Info, HelpCircle, Zap, Activity, BarChart, PieChart, TrendingUp, TrendingDown, DollarSign, ShoppingCart, Package, Truck, MapPin, Globe, Wifi, Bluetooth, Battery, Sun, Moon, Cloud, Umbrella, Thermometer, Droplet, Wind, Flame, Leaf, Tree, Mountain, Waves, Anchor, Plane, Car, Bike, Train, Ship, Rocket, Gift, Award, Trophy, Flag, Bookmark, Tag, Hash, AtSign, Code, Terminal, Database, Server, Cpu, HardDrive, Monitor, Smartphone, Tablet, Laptop, Watch, Headphones, Speaker, Mic, Volume2, VolumeX, Play, Pause, Square, SkipBack, SkipForward, Repeat, Shuffle, List, Grid, Layers, Layout, Sidebar, PanelLeft, Maximize, Minimize, Copy, Clipboard, Scissors, RotateCw, RotateCcw, RefreshCw, Filter, SortAsc, SortDesc, Move, Grip, Target, Crosshair, Navigation, Compass, Map, Route, Users, UserPlus, UserMinus, UserCheck, UserX, Building, Briefcase, GraduationCap, BookOpen, Newspaper, FileText as FileTextIcon, Image as ImageIcon, Film, Tv, Radio, Gamepad2, Dice1, Puzzle, Lightbulb, Wrench, Hammer, PaintBucket, Palette, Brush, Pen, Pencil, Eraser, Type, Bold, Italic, Underline, AlignLeft, AlignCenter, AlignRight, AlignJustify, Indent, Outdent, Quote, ListOrdered, ListChecks, Table, Rows, Columns, Merge, Split, Crop, Slice, ZoomIn, ZoomOut, Hand, Pointer, MousePointer, Fingerprint, Scan, QrCode, Barcode, Receipt, Wallet, CreditCard as CreditCardIcon, Banknote, Coins, PiggyBank, Vault, Safe, Calculator, Percent, Hash as HashIcon, Binary, Sigma, Pi, Infinity, CircleDot, Circle, CircleOff, Square as SquareIcon, Triangle, Hexagon, Octagon, Pentagon, Diamond, Gem, Crown, Sparkle, Wand2, Magic, Ghost, Skull, Bone, Bug, Virus, Pill, Syringe, Stethoscope, Microscope, FlaskConical, TestTube, Atom, Dna, Fingerprint as FingerprintIcon, Brain, Eye as EyeIcon, Ear, HandMetal, Footprints, Baby, PersonStanding, Accessibility, Wheelchair, Crutch, BedDouble, Sofa, Lamp, Fan, AirVent, Heater, Refrigerator, Microwave, CookingPot, UtensilsCrossed, Coffee, Wine, Beer, Martini, IceCream, Cake, Pizza, Sandwich, Apple, Banana, Cherry, Grape, Carrot, Salad, Egg, Croissant, Cookie, Candy, Lollipop, Popcorn, Soup, Beef, Fish, Drumstick, Milk, Citrus, Nut } from "lucide-react";
